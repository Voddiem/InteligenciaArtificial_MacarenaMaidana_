...
public class EnemyOneController : MonoBehaviour
{
    ...
    [SerializeField] private LineOfSightOne los;
    [SerializeField] private Transform[] patrolPoints;
    [SerializeField] private DecisionTreeOne dicisionTree;
    ...
    void Awake()
    {
        ...
        if (dicisionTree == null)
            dicisionTree = GetComponent<DecisionTreeOne>();

        seek = new SeekBehaviour();
        wander = new WanderBehaviour();
        arrive = new ArriveBehaviour(2.5f);

        pathfinder = FindFirstObjectByType<Theta>();
